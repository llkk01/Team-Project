...
<body>
   ...
   <div class="body-content">
      <h2>공지사항 입력</h2><br>
      <p><Strong>WASH</Strong>의 새로운 소식을 입력해주세요.</p>
      <br>
      <br>
      <form action="/noticeadd" method="post">
         <input type="text" id="title" name="title" placeholder="공지사항 제목" /><br><br>
         <br>
         <textarea id="contents" cols="50" rows="10" name="contents"
            placeholder="새로운 소식을 입력해주세요."></textarea>
         <br>
         <br>
         <div>
         ...
         <div class="main-footer_right">
            ...
            <div class="main-footer_customer">
               ...
               <br> <br> <br> <span class="main-footer_copy">서울특별시
                  ...
                  2012-서울서초-0647 &nbsp; | &nbsp; 개인정보보호책임자 : 신상훈</span><br>
               <br> <span class="main-footer_copy">COPYRIGHT ⓒ
                  LUSHKOREA CO.LTD. ALL RIGHTS RESERVED</span>
            </div>
         </div>
      </div>
   </div>
