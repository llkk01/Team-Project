...
<body>
 <div class="body-wrapper">
   ...
   <div class="body-content">
     ...
     <h1>REVIEW</h1><br>
    <span class="reviewetc">워시의 제품을 구매하신 고객님의 생생한 후기를 알려 주세요!</span><br><br>
   


<div class="reviewdetail">
<form action="/reviewadd/<%=p_no %>" method="post">
...
<textarea cols="100" rows="3" name="contents" placeholder="후기를 입력해 주세요.">${review.contents}</textarea><br>
</td>
</tr>
</table>
