...
<body>
 ...
 <div class="body-wrapper">
   ...
   <div class="body-content">
    ...
    <a href="/reviewupdate/<%=review.getNo() %>" class="a1">리뷰 수정하기</a> | <a href="/reviewdelete/<%=review.getNo() %>" class="a2">리뷰 삭제하기</a><br><br><br>
    <%} %>
...
<br>
 ...
 <a href="/reviewlist/<%=review.getProduct().getNo()%>" class="showreviewlist">목록</a> 
