...
<% int p_no = (int)request.getAttribute("p_no"); %>
 ...
 <ul class="nav2">
   ...
   <c:when test="${empty reviews}">
    ...
    <span class="reviewetc">워시의 제품을 구매하신 고객님들의 생생한 후기를 들어보세요!</span><br><br>
       ...
       <p class="reviewetc2">등록된 후기가 없습니다. 구입하신 상품의 첫 번째 후기를 남겨 주세요!</p>
  <a href="/reviewadd/<%=p_no%>" class="write1">후기 작성하기</a>
   </c:when>
   <c:otherwise>
 
    <h1>REVIEW</h1><br>
    <span class="reviewetc">워시의 제품을 구매하신 고객님들의 생생한 후기를 들어보세요!</span><br><br>
    <a href="/reviewadd/<%=p_no%>" class="write">후기 작성하기</a>
      ...
      %>
            <tr>
                <td>
                    <strong>★★★★★</strong><br><br>
                <%=review.getRdate()%><br><br>
                <%=review.getWriter().getName() %>
                </td>
                <td style=" width: 400px;   table-layout: fixed;">
                <span class="inlist"><a href ="/reviewdetail/<%=review.getNo()%>"><%=review.getContents()%></a><br><br><br></span>
                <span class="inlist">0개의 댓글이 있습니다. &nbsp;<strong>추천: 0</strong> &nbsp;<button class="b1">추천하기</button></span>
                </td>
                <td></td>                
         </tr>
      <%
